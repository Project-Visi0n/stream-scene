  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black">
      ...
      <main className="relative overflow-hidden">
        ...
        {/* Google Login - Top Left */}
        <div className="absolute top-6 left-6 z-20">
          <div className="bg-gradient-to-br from-slate-800/80 to-gray-900/80 backdrop-blur-sm border border-purple-500/30 rounded-xl p-4 shadow-xl">
