...
export type ContentType = 'tutorial' | 'showcase' | 'behind-scenes' | 'live-stream' | 'announcement' | 'community';
export type Platform = 'youtube' | 'twitch' | 'twitter' | 'instagram' | 'tiktok' | 'discord';
